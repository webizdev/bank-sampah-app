...
<div class="bg-white min-h-screen">
    <!-- Top Navigation -->
    <nav
        class="flex items-center justify-between px-6 md:px-8 py-4 md:py-6 max-w-7xl mx-auto border-b border-primary/5">
        <div class="flex items-center gap-2">
            ...
            <span
                class="text-xl md:text-2xl font-black text-primary tracking-tighter headline"><?php echo htmlspecialchars($app_name); ?>.</span>
        </div>
        <div class="hidden md:flex items-center gap-10 text-sm font-bold text-outline">
            ...
            <a href="#tentang-kami" class="hover:text-primary transition-all hover:scale-105 active:scale-95">Tentang
                Kami</a>
        ...
        <div class="grid lg:grid-cols-[1.2fr,0.8fr] md:grid-cols-2 gap-10 md:gap-16 items-center relative z-10">
            <div class="space-y-6 md:space-y-8">
                <div
                    ...
                    <span class="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-primary">Solusi
                        Limbah
                        Modern</span>
                </div>
                <h1
                    ...
                    Aplikasi Waste Management<br>
                    <span class="text-outline-thin text-transparent"
                        style="-webkit-text-stroke: 2px #2D4F1E; opacity: 0.6;">Bank Sampah</span><br>
                    Garbage Pickup.
                </h1>
            ...
            <div class="relative">
                ...
                <div
                    ...
                    <p class="text-[8px] md:text-[10px] font-bold text-outline uppercase tracking-widest">Daur Ulang
                        Berhasil</p>
                </div>
            </div>
        </div>
    ...
    <section class="px-6 md:px-8 mt-12 md:-mt-20 relative z-20 max-w-7xl mx-auto">
        <div class="grid md:grid-cols-3 gap-4 md:gap-6">
            <div
                ...
                <span
                    class="material-symbols-outlined text-3xl md:text-4xl text-primary mb-3 md:mb-4">delete_sweep</span>
                <h3 class="font-bold text-lg md:text-xl mb-2 md:mb-4 headline text-primary leading-tight">Dumpster Sizes
                </h3>
                <p class="text-xs md:text-sm text-outline leading-relaxed">Berbagai ukuran kontainer sesuai kebutuhan
                    volume sampah
                    Anda.</p>
            </div>
            <div
                class="bg-white/90 backdrop-blur-xl p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] shadow-xl border border-primary/5 hover:-translate-y-2 transition-transform">
                <span
                    class="material-symbols-outlined text-3xl md:text-4xl text-primary mb-3 md:mb-4">local_shipping</span>
                <h3 class="font-bold text-lg md:text-xl mb-2 md:mb-4 headline text-primary leading-tight">Waste
                    Collection</h3>
                <p class="text-xs md:text-sm text-outline leading-relaxed">Penjemputan rutin dan terjadwal secara
                    profesional dan
                    tepat waktu.</p>
            </div>
            <div
                class="bg-white/90 backdrop-blur-xl p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] shadow-xl border border-primary/5 hover:-translate-y-2 transition-transform">
                <span
                    class="material-symbols-outlined text-3xl md:text-4xl text-primary mb-3 md:mb-4">calendar_month</span>
                <h3 class="font-bold text-lg md:text-xl mb-2 md:mb-4 headline text-primary leading-tight">Pickup
                    Schedule</h3>
                <p class="text-xs md:text-sm text-outline leading-relaxed">Kelola jadwal penjemputan Anda dengan mudah
                    melalui
                    aplikasi.</p>
            </div>
        </div>
    ...
    <section id="layanan"
        class="py-20 md:py-32 overflow-hidden bg-surface-container-low mt-12 md:mt-20 border-y border-primary/5 shadow-inner relative">
        <div class="text-center max-w-2xl mx-auto mb-10 md:mb-16 space-y-4 px-6 md:px-8">
            <div
                class="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-primary/10 border border-primary/20 rounded-full mb-2 md:mb-4">
                <span class="material-symbols-outlined text-[14px] md:text-[16px] text-primary">smartphone</span>
                <span class="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-primary">Aplikasi
                    User</span>
            </div>
            <h2 class="text-3xl md:text-5xl font-black text-primary headline tracking-tight">Eksplorasi Fitur Kami</h2>
            <p class="text-sm md:text-base text-on-surface-variant leading-relaxed">Pantau history, cek saldo, dan atur
                penjemputan sampah dengan mudah melalui antarmuka genggaman yang modern dan interaktif.</p>
        </div>
        ...
        <style>
            @keyframes marquee {
                ...
                /* gap-6 is 1.5rem, half is 0.75rem */
            }
        ...
        <div class="relative w-full overflow-hidden pause-marquee pb-16 pt-4">
            <!-- Fade Edges -->
            <div
                class="absolute inset-y-0 left-0 w-16 md:w-40 bg-gradient-to-r from-surface-container-low to-transparent z-20 pointer-events-none">
            </div>
            <div
                class="absolute inset-y-0 right-0 w-16 md:w-40 bg-gradient-to-l from-surface-container-low to-transparent z-20 pointer-events-none">
            </div>
            ...
            <div class="animate-marquee gap-6 items-center">
                ...
                for ($i = 0; $i < 2; $i++):
                    foreach ($mockups as $index => $m):
                        ?>
                        <div
                            class="shrink-0 w-[180px] sm:w-[220px] md:w-[320px] hover:-translate-y-4 transition-transform duration-500 group relative">
                            <div
                                class="absolute inset-0 bg-primary/30 blur-3xl rounded-full scale-90 -z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            </div>
                            <div
                                class="bg-[#1a1a1a] rounded-[2.5rem] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.3)] p-[10px] md:p-[14px] relative z-10 transition-shadow group-hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)]">
                                <div
                                    class="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-5 bg-[#1a1a1a] rounded-b-[1rem] z-20">
                                </div> <!-- Notch -->
                                <div
                                    class="bg-white rounded-[1.8rem] overflow-hidden relative border border-outline-variant/20">
                                    <img src="<?php echo $m['src']; ?>" alt="<?php echo $m['alt']; ?>"
                                        class="w-full h-auto object-contain pointer-events-none block pt-2">
                                </div>
                            </div>
                        </div>
                        <?php
    ...
    <section id="tentang-kami"
        class="px-6 md:px-8 py-20 md:py-32 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div class="relative order-2 md:order-1 px-4 md:px-0">
            ...
            <div
                class="absolute -top-6 -right-6 md:-top-10 md:-right-10 bg-white p-4 md:p-8 rounded-full shadow-2xl border border-primary/5">
        ...
        <div class="space-y-6 md:space-y-8 order-1 md:order-2">
            <h2 class="text-3xl md:text-5xl font-black text-primary leading-tight headline tracking-tight">Tentang Kami
            </h2>
            <h3 class="text-lg md:text-2xl font-bold text-on-surface-variant">We're Leader In Waste Management Services
            </h3>
    ...
    <section id="harga" class="py-20 md:py-32 bg-surface-container-low relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
            <div class="text-center mb-16 md:mb-24 space-y-4">
                <div
                    class="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-primary/10 border border-primary/20 rounded-full mb-4">
                    <span class="material-symbols-outlined text-[16px] text-primary">sell</span>
                    <span class="text-[10px] font-black uppercase tracking-widest text-primary">Investasi
                        Lingkungan</span>
                </div>
                <h2 class="text-3xl md:text-5xl font-black text-primary headline tracking-tight">Pilih Paket Sesuai
                    Kebutuhan</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <!-- Bronze -->
                <div
                    class="bg-white p-8 rounded-[2rem] border border-primary/5 shadow-xl hover:-translate-y-2 transition-transform flex flex-col">
                    <div class="mb-8">
                    ...
                    <a href="https://wa.me/<?php echo $global_settings['wa_cs_number'] ?? ''; ?>"
                        class="w-full py-4 rounded-2xl bg-primary/10 text-primary font-bold text-center hover:bg-primary hover:text-white transition-all">Pilih
                        Bronze</a>
                </div>

                <!-- Silver (Recommended) -->
                <div
                    class="bg-primary p-8 rounded-[2rem] shadow-2xl hover:-translate-y-2 transition-transform relative overflow-hidden flex flex-col group border-4 border-white/20">
                    <div
                        class="absolute top-6 right-6 px-3 py-1 bg-white/20 rounded-full text-[9px] font-black text-white uppercase tracking-widest">
                        Populer</div>
                    <div class="mb-8">
                    ...
                    <a href="https://wa.me/<?php echo $global_settings['wa_cs_number'] ?? ''; ?>"
                        class="w-full py-4 rounded-2xl bg-white text-primary font-bold text-center hover:bg-primary-container hover:text-primary transition-all">Pilih
                        Silver</a>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <!-- Induk -->
                <div
                    class="bg-surface-container p-8 md:p-12 rounded-[3rem] border border-primary/10 shadow-2xl flex flex-col md:flex-row gap-8 items-center text-center md:text-left relative overflow-hidden group">
                    <div class="space-y-4 flex-grow">
                        <h4 class="text-2xl font-black text-primary headline">Bank Sampah Induk</h4>
                        <div class="text-4xl font-black text-primary">18<span class="text-xl">jt</span><span
                                class="text-on-surface-variant text-sm font-normal"> /tahun</span></div>
                        <ul class="space-y-3">
                            <li
                                class="flex items-center justify-center md:justify-start gap-3 text-sm text-on-surface-variant">
                    ...
                    <a href="https://wa.me/<?php echo $global_settings['wa_cs_number'] ?? ''; ?>"
                        class="shrink-0 px-8 py-4 rounded-2xl bg-primary text-white font-black hover:scale-105 transition-transform shadow-lg">Chat
                        Sales</a>
                    <div
                        class="absolute -right-12 -bottom-12 w-48 h-48 bg-primary/5 rounded-full blur-3xl group-hover:bg-primary/10 transition-colors">
                    </div>
                </div>

                <!-- Enterprise -->
                <div
                    class="bg-on-surface p-8 md:p-12 rounded-[3rem] shadow-2xl flex flex-col md:flex-row gap-8 items-center text-center md:text-left relative overflow-hidden group">
                    <div class="space-y-4 flex-grow">
                    ...
                    <a href="https://wa.me/<?php echo $global_settings['wa_cs_number'] ?? ''; ?>"
                        class="shrink-0 px-8 py-4 rounded-2xl bg-white text-on-surface font-black hover:scale-105 transition-transform shadow-lg">Konsultasi</a>
                    <div
                        class="absolute -right-12 -bottom-12 w-48 h-48 bg-white/5 rounded-full blur-3xl group-hover:bg-white/10 transition-colors">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-primary py-16 md:py-24 px-6 md:px-8 overflow-hidden relative">
        <div class="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 relative z-10">
            <div class="text-center space-y-1 md:space-y-2">
                ...
                <p class="text-white/60 text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em]">Pelanggan Puas
                </p>
            </div>
            <div class="text-center space-y-1 md:space-y-2">
                <h4 class="text-3xl sm:text-4xl md:text-6xl font-black text-white headline tracking-tight">150+</h4>
                <p class="text-white/60 text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em]">Kemitraan
                    Organisasi</p>
            </div>
            <div class="text-center space-y-1 md:space-y-2">
                <h4 class="text-3xl sm:text-4xl md:text-6xl font-black text-white headline tracking-tight">130</h4>
                <p class="text-white/60 text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em]">Staf Lapangan
                </p>
            </div>
            <div class="text-center space-y-1 md:space-y-2">
                <h4 class="text-3xl sm:text-4xl md:text-6xl font-black text-white headline tracking-tight">32+</h4>
                <p class="text-white/60 text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em]">Provinsi
                    Tercover</p>
            </div>
        </div>
        <div
            class="absolute top-0 right-0 w-64 md:w-96 h-64 md:h-96 bg-white/5 blur-[80px] md:blur-[120px] rounded-full">
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div
                ...
                <div class="mb-6 md:mb-8 font-medium">
                    ...
                    <p class="italic text-on-surface-variant text-sm md:text-base leading-relaxed">"Mudah sekali menjual
                        sampah di sini.
            ...
            <div
                ...
                <div class="mb-6 md:mb-8 font-medium">
                    ...
                    <p class="italic text-white text-sm md:text-base leading-relaxed">"Aplikasi paling inovatif untuk
                        pengelolaan bank
                ...
                <div class="flex items-center gap-4 border-t border-white/10 pt-6 md:pt-8">
                    ...
                    <div>
                        ...
                        <p class="text-[9px] md:text-[10px] text-white/60 font-bold uppercase">Sustainability Advocate
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="mb-6 md:mb-8 font-medium">
                    ...
                    <p class="italic text-on-surface-variant text-sm md:text-base leading-relaxed">"Sangat terbantu
    ...
    <footer id="kontak" class="bg-[#1A2E12] text-white py-12 md:py-20 px-6 md:px-8 mt-12 md:mt-20">
        <div class="max-w-7xl mx-auto text-center">
            <div class="flex items-center justify-center gap-2 mb-6 md:mb-8">
                <div
                    class="w-10 h-10 md:w-12 md:h-12 bg-primary rounded-xl md:rounded-2xl flex items-center justify-center text-white">
                    <span class="material-symbols-outlined text-[24px] md:text-[32px]">recycling</span>
                </div>
                <span
                    class="text-2xl md:text-4xl font-black text-white tracking-tighter headline"><?php echo htmlspecialchars($app_name); ?>.</span>
            </div>
            <p class="max-w-xl mx-auto text-white/50 text-xs md:text-sm mb-10 md:mb-12">
                Bergabunglah bersama kami untuk menciptakan lingkungan yang lebih bersih.
                <?php echo htmlspecialchars($app_name); ?> adalah jembatan antara
            ...
            <div class="flex justify-center gap-6 mb-12">
                <?php if (!empty($global_settings['social_instagram'])): ?>
                    <a href="<?php echo htmlspecialchars($global_settings['social_instagram']); ?>" target="_blank"
                ...
                <?php if (!empty($global_settings['social_facebook'])): ?>
                    <a href="<?php echo htmlspecialchars($global_settings['social_facebook']); ?>" target="_blank"
                        class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary transition-colors">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                            <path
                ...
                <?php if (!empty($global_settings['social_twitter'])): ?>
                    <a href="<?php echo htmlspecialchars($global_settings['social_twitter']); ?>" target="_blank"
                        class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary transition-colors">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                            <path
            ...
            <div
                class="flex flex-wrap justify-center gap-4 md:gap-8 mb-12 md:mb-16 font-bold uppercase tracking-widest md:tracking-[0.3em] text-[9px] md:text-[10px]">
            ...
            <p class="text-white/20 text-[9px] font-black uppercase tracking-widest border-t border-white/5 pt-12">
                © <?php echo date('Y'); ?> <?php echo htmlspecialchars($app_name); ?>. All Rights Reserved. Designed for
                the Future.
            </p>
        </div>
    </footer>
